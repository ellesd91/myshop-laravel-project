...
// Wait for the entire page to load before running the chart code.
$(function() {
    ...
    if (ctx_pie) {
        var myPieChart = new Chart(ctx_pie, {
            ...
            options: { maintainAspectRatio: false, tooltips: { backgroundColor: "rgb(255,255,255)", bodyFontColor: "#858796", borderColor: '#dddfeb', borderWidth: 1, xPadding: 15, yPadding: 15, displayColors: false, caretPadding: 10, }, legend: { display: false }, cutoutPercentage: 80 }
        });
    }
});
